...
public:
	...
	//mutators
	virtual void __mouseEvent(int x, int y, int button); //-1 for none.
	virtual void __keyboardEvent(bool pressed, int keyboard_key, int keyboard_flag, int keyboard_char);
	//accessors
